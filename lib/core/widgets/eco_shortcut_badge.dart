      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? [const Color(0xFF1E1E1E), const Color(0xFF1A2E1C)]
                : [const Color(0xFFFFFFFF), const Color(0xFFF5FFF6)],
          ),
          borderRadius: BorderRadius.circular(26),
          border: Border.all(color: Colors.green.withValues(alpha: isDark ? 0.32 : 0.24)),
          boxShadow: [
            BoxShadow(
