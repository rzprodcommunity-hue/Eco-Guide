class Poi {
  ...
  static String? _parseTrailId(Map<String, dynamic> json) {
    final direct = json['trailId'];
    if (direct is String && direct.trim().isNotEmpty) {
      return direct;
    }

    final snakeCase = json['trail_id'];
    if (snakeCase is String && snakeCase.trim().isNotEmpty) {
      return snakeCase;
    }

    final nestedTrail = json['trail'];
    if (nestedTrail is Map) {
      final nestedId = nestedTrail['id'];
