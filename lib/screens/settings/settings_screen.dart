...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  static Color _pageBg(BuildContext context) =>
  ...
  static Color _subtitleColor(BuildContext context) =>
      Theme.of(context).brightness == Brightness.dark
  ...
  static Color _mutedColor(BuildContext context) =>
      Theme.of(context).brightness == Brightness.dark
          ...
          : const Color(0xFF8C8895);

  // Keep static versions for widgets that can't access context easily
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _SettingsScreenState._cardBg(context),
...
class _ThemeToggleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleColor = _SettingsScreenState._titleColor(context);
    final subtitleColor = _SettingsScreenState._subtitleColor(context);
