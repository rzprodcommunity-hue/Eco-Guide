  ...
  void initState() {
    ...
    try {
      ...
      SocketService.on('trail_updated', (data) {
        if (mounted) {
          debugPrint('📡 Real-time update: Trail ${data['action']}');
      ...
      SocketService.on('poi_updated', (data) {
        if (mounted) {
          debugPrint('📡 Real-time update: POI ${data['action']}');
          _refreshRealtimeData();
        }
      });
      ...
      SocketService.on('service_updated', (data) {
        if (mounted) {
          debugPrint('📡 Real-time update: Service ${data['action']}');
          _refreshRealtimeData();
        }
      });
      ...
      SocketService.on('quiz_updated', (data) {
        if (mounted) {
          debugPrint('📡 Real-time update: Quiz ${data['action']}');
