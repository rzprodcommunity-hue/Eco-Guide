...
class _SosScreenState extends State<SosScreen> with TickerProviderStateMixin {
  ...
  Future<void> _triggerSos() async {
    ...
    try {
      ...
      // Use the user-typed message, or fall back to a default one.
        ...
        actions: [
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              ...
              final body = userMsg.isNotEmpty
                  ? "URGENCE ECO-GUIDE - $userMsg. Position GPS : ${_currentPosition.latitude}, ${_currentPosition.longitude}. Envoyez des secours."
                  : "URGENCE ECO-GUIDE - Je suis à la position GPS : ${_currentPosition.latitude}, ${_currentPosition.longitude}. Envoyez des secours.";
              final link = 'sms:112?body=${Uri.encodeComponent(body)}';
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.message_outlined,
                  color: Color(0xFFC83226), size: 20),
              const SizedBox(width: 8),
              Text(
                context.watch<LocaleProvider>().t('sos.messageLabel'),
                style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.bold,
                  color: Theme.of(context).colorScheme.onSurface,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: context.watch<LocaleProvider>().t('sos.messageHint'),
