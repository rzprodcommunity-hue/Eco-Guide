...
class WeatherService {
  ...
  /// Fetches current weather. First tries the backend, then falls back
  /// to calling the Open-Meteo API directly for guaranteed real-time data.
  Future<Weather> getCurrentWeather({double? lat, double? lng}) async {
    ...
    try {
      ...
      // Backend unavailable – call Open-Meteo directly
      return _fetchFromOpenMeteo(lat, lng);
    }
  }
