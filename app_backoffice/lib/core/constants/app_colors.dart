...
class AppColors {
  ...
  // ── Dark navigation chrome (sober dark mode) ───────────────────────────
  // Used by the shell (sidebar + top bar) when dark mode is enabled. The
  // content area stays light to keep the data screens readable.
  static const Color darkSurface = Color(0xFF1C2025);
  static const Color darkSurfaceAlt = Color(0xFF23282F);
